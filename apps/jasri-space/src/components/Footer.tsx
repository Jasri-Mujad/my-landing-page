...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="relative z-50 mt-auto border-t border-white/5 bg-[#0a0f14] py-12">
            <div className="max-w-[1200px] mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-400 text-sm">© 2026 Cozy Space by Jasri. All rights reserved.</span>
                </div>
